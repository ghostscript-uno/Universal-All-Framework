...
# Your personal identity info
identity_info = {
    "name": "Perry Philip Wiseman",
    "birthdate": "1977-05-24",
    "ssn": "***-**-6273"  # Masked partial SSN for privacy
}
...
if computed_hash == data["merkle_root"]:
    print("✅ Ownership integrity verified with identity binding")
else:
    print("❌ Hash mismatch — file may be altered or Merkle root not updated with identity")
